...
// Package types contains data types related to Popcateum consensus.
package types
...
// Header represents a block header in the Popcateum blockchain.
type Header struct {
...
// Block represents an entire block in the Popcateum blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the Popcateum
...
// EncodeRLP serializes b into the Popcateum RLP block format.
