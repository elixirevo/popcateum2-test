...
// timestampThreshold is the Popcateum mainnet genesis timestamp. It is used to
...
// NewID calculates the Popcateum fork ID from the chain config, genesis hash, head and time.
...
// NewIDWithChain calculates the Popcateum fork ID from an existing chain instance.
