...
pruning. Remember don't start the Gpop without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "gpop snapshot prune-state --help" for more details.
`
