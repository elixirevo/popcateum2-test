...
// It can be used for testing that restart Gpop normally.
...
// It can be used for testing that restart Gpop after the crash.
...
// Tests a Gpop restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Gpop was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Gpop was crashed and restarts with a broken snapshot. In this case
...
// Tests a Gpop was running with snapshot enabled. Then restarts without
...
// Tests the Gpop was running with snapshot enabled and resetHead is applied.
...
// Tests the Gpop was running with a complete snapshot and then imports a few
