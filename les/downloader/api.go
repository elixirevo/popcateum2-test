...
// Syncing provides information when this nodes starts synchronising with the Popcateum network and when it's finished.
...
type SyncingResult struct {
	...
	Status  popcateum.SyncProgress `json:"status"`
}
