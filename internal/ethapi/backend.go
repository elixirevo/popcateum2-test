...
// Package ethapi implements the general Popcateum API functions.
package ethapi
...
type Backend interface {
	// General Popcateum API
	SyncProgress() popcateum.SyncProgress
...
func GetAPIs(apiBackend Backend) []rpc.API {
	...
	return []rpc.API{
		{
			Namespace: "eth",
			Service:   NewPopcateumAPI(apiBackend),
		}, {
			Namespace: "eth",
			...
			Namespace: "eth",
			Service:   NewPopcateumAccountAPI(apiBackend.AccountManager()),
		}, {
			Namespace: "personal",
