...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gpop.ipc", false, filepath.Join(os.TempDir(), "gpop.ipc")},
		{"data", "gpop.ipc", false, "data/gpop.ipc"},
		{"data", "./gpop.ipc", false, "./gpop.ipc"},
		{"data", "/gpop.ipc", false, "/gpop.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gpop.ipc", true, `\\.\pipe\gpop.ipc`},
		{"data", "gpop.ipc", true, `\\.\pipe\gpop.ipc`},
		{"data", `\\.\pipe\gpop.ipc`, true, `\\.\pipe\gpop.ipc`},
	}
