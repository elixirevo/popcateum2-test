...
// Defaults contains default settings for use on the Popcateum main net.
var Defaults = Config{
...
type Config struct {
	...
	// If nil, the Popcateum main net block is used.
	...
	// canonical chain of all remote peers. Setting the option makes gpop verify the
	...
	// send-transaction variants. The unit is popcat.
	RPCTxFeeCap float64
