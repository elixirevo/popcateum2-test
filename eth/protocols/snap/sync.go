...
import (
	...
	"github.com/popcateum/go-popcateum/p2p/msgrate"
...
// Syncer is an Popcateum account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Popcateum state over the
// snap protocol.
