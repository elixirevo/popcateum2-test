...
import (
	...
	lru "github.com/popcateum/go-popcateum/common/lru"
...
// ecrecover extracts the Popcateum account address from a signed header.
func ecrecover(header *types.Header, sigcache *sigLRU) (common.Address, error) {
	...
	// Recover the public key and the Popcateum address
...
// Popcateum testnet following the Longcat attacks.
type Clique struct {
	...
	signer common.Address // Popcateum address of the signing key
...
// Author implements consensus.Engine, returning the Popcateum address recovered
