...
// mapped from textual names used in the tests below to actual Popcateum private
...
// address retrieves the Popcateum address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Popcateum address
	...
	tests := []cliqueTest{
		{
			...
			// batch (https://github.com/popcateum/go-popcateum/issues/17593). Whilst this
