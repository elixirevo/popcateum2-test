...
// Package ethclient provides a client for the Popcateum RPC API.
package ethclient
...
// Client defines typed wrappers for the Popcateum RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, popcateum.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*popcateum.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (popcateum.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q popcateum.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q popcateum.FilterQuery, ch chan<- types.Log) (popcateum.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q popcateum.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg popcateum.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg popcateum.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg popcateum.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*popcateum.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg popcateum.CallMsg) (uint64, error) {
...
func toCallArg(msg popcateum.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *popcateum.SyncProgress {
	if p == nil {
		return nil
	}
	return &popcateum.SyncProgress{
