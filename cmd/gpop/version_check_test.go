...
func TestGpopPubKeysParseable(t *testing.T) {
	for _, pubkey := range gpopPubKeys {
...
func TestKeyID(t *testing.T) {
	...
	tests := []struct {
		...
		{"@holiman key", args{id: extractKeyId(gpopPubKeys[0])}, "FB1D084D39BAEC24"},
		{"second key", args{id: extractKeyId(gpopPubKeys[1])}, "138B1CA303E51687"},
		{"third key", args{id: extractKeyId(gpopPubKeys[2])}, "FD9813B2D2098484"},
	}
