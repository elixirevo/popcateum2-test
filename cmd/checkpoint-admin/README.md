...
There are several hardcoded checkpoints in the [source code](https://github.com/ethereum/go-ethereum/blob/master/params/config.go#L38) of the go-popcateum project. These checkpoints are updated by go-popcateum developers when new versions of software are released. Because light client users trust Gpop developers to some extent, hardcoded checkpoints in the code can also be considered correct.
